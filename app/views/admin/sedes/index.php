...
// Asegúrate de verificar si el usuario está autenticado
...
$email = isset($_SESSION['email']) ? $_SESSION['email'] : 'Invitado'; // Valor predeterminado si no está definido
?>
            ...
            <section class="cards-container">
                ...
                <div class="card text-center">
                    <a
                        ...
                        class=""
                    >
                        <img src="../../public/imgs/cajero.webp" alt="">
                        <h5>Nuevo Cajero</h5>
                    </a>
                </div>
                ...
                <div class="card text-center">
                    <a
                        ...
                        class="">
                        <img src="../../public/imgs/mesero.webp" alt="">
                        <h5>Nuevo Mesero</h5>
                    </a>
                </div>
                ...
                <div class="card text-center">
                    <a 
                        ...
                        class="">
                        <img src="../../public/imgs/admin.webp" alt="">
