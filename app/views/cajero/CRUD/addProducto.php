...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO productos (nombreProducto, precio, costo, cantidad) VALUES (?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sssi", $nombreProducto, $precio, $costo, $cantidad);
    $stmt->execute();
...
<div class="container mt-5">
    ...
    <form method="POST">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="costo" name="costo" min=1 required>
        </div>
        <div class="form-group">
        ...
        <span id='error-text' style='display: none; color: red;'>Error</span>
