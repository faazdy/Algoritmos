              ...
              <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                ...
                <div class="offcanvas-body">
                  <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item">
                      <a class="nav-link text-light" aria-current="page" href="mesero_pedido.php">Tus mesas</a>
                    </li>
                    <li class="nav-item">
...
<div class="container mt-5">
    <div class="hero">
        ...
        <p>
            Productos en el menú disponibles.
        </p>
    </div>
    ...
    <a href="../indexMesero.php" class="btn btn-dark">Inicio</a>
</div>
