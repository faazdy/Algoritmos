            ...
            <div class="container-fluid">
              ...
              <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                <div class="offcanvas-header">
                  <h5 class="offcanvas-title" id="offcanvasDarkNavbarLabel">Hola, <span style='color: rgb(180, 133, 255);'>{{ Auth::user()->email }}</span></h5>
                ...
                <div class="offcanvas-body">
                  <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item">
                      <a class="nav-link text-light" aria-current="page" href="#">Registrar Cajero</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link text-light" aria-current="page" href="#">Registrar Mesero</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link text-light" aria-current="page" href="#">Registrar Administrador</a>
                    </li>
        ...
        <main style="background-color: rgb(250, 250, 250);">
            ...
            <section class="cards-container">
                ...
                <div class="card text-center">
                    <a
                        href="{{ url('create/cajero') }}"
                        class=""
                    >
                        <img src="{{ asset('imgs/cajero.webp') }}" alt="">
                        <h5>Nuevo Cajero</h5>
                    </a>
                </div>
                ...
                <div class="card text-center">
                    <a
                        href="{{ url('create/mesero') }}"
                        class="">
                        <img src="{{ asset('imgs/mesero.webp') }}" alt="">
                        <h5>Nuevo Mesero</h5>
                    </a>
                </div>
                ...
                <div class="card text-center">
                    <a 
                        href="{{ url('create/admin') }}" 
                        class="">
                        <img src="{{ asset('imgs/admin.webp') }}" alt="">
            ...
            <section class="cards-container">
                <div class="card text-center">
                    <a href="">
                        <img src="{{ asset('imgs/sede.webp') }}" alt="">
